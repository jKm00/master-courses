...
- [x] Methodologies for deployment of information systems
...
- **Enterprise IS:** organizations use to define structured interactions among their employees and/or external customers, suppliers, government agencies, etc.
...
1. Development: New system or replacement system
2. Maintenance: Enhancive, corrective, adaptive, perfective

#### History

- Waterfall method
  - Difficult to change such systems
  - Suggested more iterative approaches
- Agile development

### Enterprise Architecture

- A conceptual model that describes how a business is constructed. It identifies primary components and shows the relationship between them.
- Different people want to understand different parts of the business
- Simplify the complexity and understand how business and technology work together.

#### Why?

Need to make sure the components are all working together to produce value that the customer will pay for.
...
All the hardware and the infrastructure needed to support all of the above.

#### EA's role

Encapsulates all these areas to keep an overview of the components in the business and keep the technology aligned with how the business operates.

### Business Information Systems

Used to convert external and internal data into useful information.

#### Transaction Processing Systems

IS that keeps track of transactions in an organization.

**Example:** When a purchase is made a TPS has to store a record of this purchase

#### Enterprise Resource Planning

A system that integrates all functions/systems required to run a business into one complete system. Streamlining collaboration between parties in the business.

#### Supply Chain Management

A system that manages the supply chain, making sure all parties can communicate and collaborate.

Five stages:

1. **Operational strategy:** The business defines what its ultimate goal is.
2. **Sourcing:** Find out what resources are needed and from where.
3. **Making:** Assemble the resources into a finished product
4. **Delivery:** Transport the product from assembly site to warehouses/customers
5. **Returns:** Make it possible for customers to return products

#### Customer Relationship Management

A system that keeps track of customers and potential customers for a business. When some information about a customer is changed in the CRM system, all relevant parties in the business are notified making them prepared and aware of that customer's status. 

#### Product Lifecycle Management

A product-centric business approach enabled through PLM system:

- A system that connects all it-systems in a business so that one can share and access information within the whole company and through the product lifecycle.
